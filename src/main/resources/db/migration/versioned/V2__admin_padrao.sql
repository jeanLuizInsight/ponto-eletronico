...
VALUES (NULL, '82198127000121', CURRENT_DATE(), CURRENT_DATE(), 'Zanatta IT');
...
VALUES (NULL, '16248890935', CURRENT_DATE(), CURRENT_DATE(), 'admin@zanatta.com', 'ADMIN', 'ROLE_ADMIN', NULL, NULL, 
